...
const makeLink = (e1, e1ToE2Relation, e2, cache, isOwn, relationPropertyIsSet) => {
  ...
  .then((isLinked) => {
    return (isLinked && Q() || setRelationPropertyInE1(cache, e1, e1ToE2Relation, e2, isOwn))
    .then(() => {
...
const isAlreadyDualLinked = (e1, e2, e1ToE2Relation, cache) => {
  ...
  .then((e1LinkedToE2) => {
    ...
    return isAlreadyLinked(e2, e1, e2ToE1Relation, cache)
    .then((e2LinkedToE1) => {
      return e2LinkedToE1
    })
  })
