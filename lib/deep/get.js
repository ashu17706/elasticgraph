...
/**
   ...
   * @param {Array} fieldsToFetch for this entity. If this does not return valid fields to be fetched, the joins param is used to fetch the fields
   * @param {String} joins The joins to do for this entity or can an Object
