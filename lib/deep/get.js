'use strict'
const debug = require('debug')('elasticgraph:deep/get')
...
/**
   ...
   * @param {Array} fields fieldsToFetch for this entity. If this does not return valid fields to be fetched, the joins param is used to fetch the fields
   * @param {String} joins The joins to do for this entity or an Object
   * @return {Object} return undefined if not found for given Id and type
   **/
