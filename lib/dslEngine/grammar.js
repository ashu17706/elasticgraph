...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c94 = "Flush every ",
      peg$c95 = peg$literalExpectation("Flush every ", false),
      peg$c96 = /^[0-9]/,
      peg$c97 = peg$classExpectation([["0", "9"]], false, false),
      peg$c98 = " cycles",
      peg$c99 = peg$literalExpectation(" cycles", false),
      peg$c100 = "Wait for",
      peg$c101 = peg$literalExpectation("Wait for", false),
      peg$c102 = "millis",
      peg$c103 = peg$literalExpectation("millis", false),
      peg$c104 = function(index, where, as, from, size, flush, wait) {
          return {
      ...
      peg$c107 = "kip",
      peg$c108 = peg$literalExpectation("kip", false),
      peg$c109 = function(size) {
          return size
        },
      peg$c110 = /^[G\/g]/,
      peg$c111 = peg$classExpectation(["G", "/", "g"], false, false),
      peg$c112 = "et",
      peg$c113 = peg$literalExpectation("et", false),
      peg$c114 = "at a time",
      peg$c115 = peg$literalExpectation("at a time", false),
      peg$c116 = "Join from",
      peg$c117 = peg$literalExpectation("Join from", false),
      peg$c118 = function(joinType) {
          return {
            joins: joinType
          }
        },
      ...
      peg$c121 = function(jsonOrWord) {
            return jsonOrWord
          },
      peg$c122 = "S",
      peg$c123 = peg$literalExpectation("S", false),
      peg$c124 = "s",
      peg$c125 = peg$literalExpectation("s", false),
      peg$c126 = "top here",
      peg$c127 = peg$literalExpectation("top here", false),
      peg$c128 = function() {
      	return {
      		command: 'stopHere'
      	}
      ...
      peg$c131 = "isplay",
      peg$c132 = peg$literalExpectation("isplay", false),
                            ...
                            if (s13 !== peg$FAILED) {
                              ...
                              if (s14 !== peg$FAILED) {
                                ...
                                if (s15 !== peg$FAILED) {
                                  ...
                                  if (s16 !== peg$FAILED) {
                                    peg$savedPos = s0;
                                    s1 = peg$c104(s2, s3, s4, s8, s10, s12, s15);
                                    s0 = s1;
                                  } else {
                                    peg$currPos = s0;
                                    s0 = peg$FAILED;
