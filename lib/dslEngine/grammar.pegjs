...
statement
  = get / search / async / index / link / unlink/ assignment / booleanExpression / unset / iterate / stopHere

conditionalStatement = ('if' / 'If') space condition:booleanExpression (space+ / (',' space*)) instruction:statement '\.'? space* ('E' / 'e')'lse' elseStatement:start {
	return {
		command: 'conditionalStatement',
		condition: condition,
		instruction: instruction,
		elseInstruction: elseStatement
	}	
}
